...
var howManyFilters = 8;		// How many filters in the wheel? This does not mean the number of slots
...
//
{
	...
	if ( filName == "S-II" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "9.0");
	} 

	if ( filName == "O-III" )
	{
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "7.5");
	} 

	if ( filName == "Clear" )
	{
	
		ccdsoftCamera.setPropDbl("m_daf2CalibrationExposureTime", "0.55");
